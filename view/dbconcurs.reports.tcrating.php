<div class="mainframe">
  <div class="subheader">Информация о подготовке участников конкурса педагогами</div>
  ...
  <form class="transpform" name="formform"
        action="/dbconcurs/reporttcrating" method="post">
  ...
  <div id="toprint">
  	<div class="printable">
  		...
  		<h1 align="center">Информация о подготовке участников конкурсов
    ...
    <table class="smptable overablerow" id="olymptable">
          ...
          <td>
            <?php foreach($data_works[$rec['olymp_teacher_id']] as $rec2) { ?>
              <?=$rec2['ctname']?>: участников <?=$rec2['cnt']?>, дипломов <?=$rec2['cntdipl']?><br>
            <?php } ?>
          </td>
  			</tr>
  		<?php } } else { ?>
