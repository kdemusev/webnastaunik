<div class="mainframe">
  <div class="subheader">Список участников III этапа олимпиады</div>
  ...
  <form class="transpform" name="formform"
        action="/dbolymp/reportpartreg" method="post">
  ...
  <div id="toprint">
  	<div class="printable">
  		...
  		<h1 align="center">Список участников III этапа
    ...
    <table class="smptable overablerow">
  		...
  		<?php } } else { ?>
        <tr>
          <td colspan="<?php if($_SESSION['olymp_subject_id']==0) { ?>8<?php } else {?>7<?php } ?>" align="center">
